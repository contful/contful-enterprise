...
type FieldCreate struct {
	...
	Description        string   `json:"description"`
	FieldType          string   `json:"field_type" binding:"required,oneof=text rich_text number boolean date datetime email url json enum"`
...
type FieldUpdate struct {
	...
	Description        *string `json:"description"`
	FieldType          *string `json:"field_type" binding:"omitempty,oneof=text rich_text number boolean date datetime email url json enum"`
	Config             *JSONB  `json:"config"`
	Validation         *JSONB  `json:"validation"`
	Display            *JSONB  `json:"display"`
	DefaultValue       *JSONB  `json:"default_value"`
